...
class HappyShopCategoryAdmin(HappyShopAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        if db_field.name == 'parent':
             kwargs["queryset"] = HappyShopCategory.objects.filter(parent__isnull=True)
...
class HappyShopBrandAdmin(HappyShopAdmin):
    ...
    def formfield_for_manytomany(self, db_field, request, **kwargs):
        ...
        if db_field.name == 'categories':
            kwargs['queryset'] = HappyShopCategory.objects.filter(parent__isnull=False)
...
class HappyShopOrderInfoAdmin(HappyShopAdmin):
    ...
    list_display = ('id','owner', 'order_sn', 'pay_status', 'pay_method', 'order_product', 'total_amount', 'freight', 'pay_time', )
    ...
    def order_product(self, obj):
        ...
        for product in product_queryset:
            ...
            product_list.append("规格：{}".format(','.join(product.sku.get_options)))
